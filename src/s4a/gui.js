...
IDE_Morph.prototype.snapMenu = function () {
    ...
    menu.addItem('About GIMBot...', 'aboutGimbot');
    menu.addLine();
    menu.addItem(
...
██   ██ ██████   ██████   ██████     ██     ██████  ██ ██      ██ ██████   ██████     ██
*/
IDE_Morph.prototype.aboutGimbot = function () {
    var dlg, aboutTxt, creditsTxt, translations,
    module, aboutBtn, creditsBtn,
    world = this.world();

    aboutTxt = 'GIMBOT IDE' + 001 +'\n'

    + 'Copyright \u24B8 2016 Donny Rhomanzah and gimbot.garuda3.id\n'
    + 'donny@garuda3.id\n'
    + 'http://gimbot.garuda3.id\n\n'

    + 'GIMBot IDE is simple IDE for programming and developing\n'
    + 'GIMBot devices.\n\n'

    + 'Copyright \u24B8 2016 Garuda3 Indonesia\n'
    + 'gimbot-rnd@garuda3.id\n\n'
